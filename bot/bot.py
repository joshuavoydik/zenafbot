...
def meditate(bot, update):
    ...
    def successCallback(name_to_show, value, update):
        bot.send_message(chat_id=update.message.from_user.id, text="🙏 You meditated for {} minutes 🙏".format(value))
...
def sleep(bot, update):
    ...
    def successCallback(name_to_show, value, update):
        bot.send_message(chat_id=update.message.from_user.id, text="💤 You slept for {} hours 💤".format(value))
